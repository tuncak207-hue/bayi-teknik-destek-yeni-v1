/// Türkiye'nin 81 ili ve ilçeleri — il/ilçe dinamik seçim sistemi için.
/// Kullanıcı isteği: "İl seçildiğinde o ile ait ilçeler otomatik
/// gelmeli, ilçe listesi seçilen ile göre dinamik filtrelenmeli, il
/// değiştirildiğinde önceki ilçe seçimi otomatik temizlenmeli."
const Map<String, List<String>> kTurkeyProvinceDistricts = {
  ...
  'Düzce': ['Akçakoca', 'Merkez', 'Cumayeri', 'Çilimli', 'Gölyaka', 'Gümüşova', 'Kaynaşlı', 'Yığılca'],
};
