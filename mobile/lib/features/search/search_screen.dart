...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    final documents =
        _scope == _SearchScope.all || _scope == _SearchScope.documents
        ? (_results?['documents'] as List?) ?? []
        : [];
    final dealers = _scope == _SearchScope.all || _scope == _SearchScope.dealers
        ? (_results?['dealers'] as List?) ?? []
        : [];
    final posts = _scope == _SearchScope.all || _scope == _SearchScope.posts
        ? (_results?['posts'] as List?) ?? []
        : [];
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            AppPageHeader(
              title: widget.documentsOnly ? 'Doküman Ara' : 'Arama',
            ),
            Padding(
                ...
                child: Row(
                  children: [
                    ...
                    _ScopeChip(
                      ...
                      onTap: () =>
                          setState(() => _scope = _SearchScope.documents),
                    ),
                    const SizedBox(width: 6),
                    _ScopeChip(
                      label: 'Bayiler',
                      ...
                      onTap: () =>
                          setState(() => _scope = _SearchScope.dealers),
                    ),
                    const SizedBox(width: 6),
                    _ScopeChip(
                      label: 'Gönderiler',
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        if (dealers.isNotEmpty) ...[
                          ...
                          ...dealers.map(
                            (u) => _ResultCard(
                              avatarLetter: (u['company'] as String? ?? '?')
                                  .characters
                                  .first
                                  .toUpperCase(),
                              title: u['company'] ?? '',
                        ...
                        if (posts.isNotEmpty) ...[
                          const _SectionHeader(
                            title: 'Bayilere Sor Gönderileri',
