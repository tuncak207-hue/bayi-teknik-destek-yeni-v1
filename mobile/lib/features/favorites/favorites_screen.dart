...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Future<void> _removeDocumentFavorite(String documentId) async {
    ...
    setState(
      () => _favorites.removeWhere((f) => f['document']?['id'] == documentId),
    );
  }
  ...
  Future<void> _removeMessageFavorite(String messageId) async {
    ...
    setState(
      () => _favorites.removeWhere((f) => f['message']?['id'] == messageId),
    );
  }
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Text('Favorilerim', style: AppText.screenTitle),
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      tooltip: isPinned
                                          ? 'Ana Sayfa\'dan kaldır'
                                          : 'Ana Sayfa\'da sabitle',
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () => _removeDocumentFavorite(
                                        document['id'],
                                      ),
                                    ),
                                  ],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      tooltip: 'Favorilerden kaldır',
                                      onPressed: () =>
                                          _removeMessageFavorite(message['id']),
                                    ),
                                  ],
                                ),
                              ),
