...
class _CommunityScreenState extends State<CommunityScreen> {
  ...
  void initState() {
    ...
    _dio
        .post('/notifications/mark-category-read/community')
  ...
  Future<void> _load() async {
    ...
    final res = await _dio.get(
      '/community/posts',
      queryParameters: _selectedTag != null ? {'tag': _selectedTag} : null,
    );
    setState(() {
      _posts = res.data;
      _loading = false;
  ...
  Future<void> _deletePost(String postId) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text(
          'Bu gönderiyi (ve tüm yorumlarını) silmek istediğinize emin misiniz?',
        ),
        actions: [
          TextButton(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final companyInitial =
                              (author?['company'] as String?)?.isNotEmpty ==
                                  true
                              ? (author['company'] as String).characters.first
                                    .toUpperCase()
                              : '?';
                          return StandardCard(
...
class _CreatePostSheetState extends State<_CreatePostSheet> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_isEditing) {
        await _dio.patch(
          '/community/posts/${widget.existingPost['id']}',
          data: payload,
        );
      } else {
  ...
  Widget _buildIosScaffold(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      ...
      navigationBar: CupertinoNavigationBar(
        ...
        middle: Text(
          _isEditing ? 'Gönderiyi Düzenle' : 'Soru Paylaş',
