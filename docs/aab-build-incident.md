...
Son doğrulama run 33122073984: `FIREBASE_GOOGLE_SERVICES_JSON_B64` decode edildi; hata `Invalid Base64: ANDROID_KEY_PROPERTIES_B64` olarak kesinleşti. Firebase secret artık sorun değil. Bir sonraki işlem yalnızca `ANDROID_KEY_PROPERTIES_B64` değerini yeniden oluşturmaktır.
